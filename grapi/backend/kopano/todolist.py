...
class TodoListResource(FolderResource):
    ...
    def handle_post_tasks(self, req, resp, store, folderid):
        ...
        item = self.create_message(folder, fields, TaskResource.set_fields)
    ...
    def handle_post_childFolders(self, req, resp, store, folderid):
        ...
        self.respond(req, resp, child, TodoListResource.fields)
    ...
    def _handle_post_copyOrMove(self, req, resp, store, folderid, move=False):
        ...
        self.respond(req, resp, new_folder, TodoListResource.fields)
